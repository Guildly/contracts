...
@pytest.mark.asyncio
async def test_keccak(contract_factory):
    ...
    # result = await signer1.send_transaction(
    #     account=account1,
    #     to=guild_proxy.contract_address,
    #     selector_name="test_keccak",
    #     calldata=[str_to_felt("kill_goblin")],
    # )

    # print(result.result)
    # print(to_uint(get_selector_from_name("kill_goblin")))
    print(get_selector_from_name("transferFrom"))
    print(get_selector_from_name("safeTransferFrom"))
    print(get_selector_from_name("approve"))
