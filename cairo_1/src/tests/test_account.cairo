...
#[test]
#[available_gas(2000000)]
fn test_validate() {// todo: requires mocking TxInfo
...
#[test]
#[available_gas(2000000)]
fn test_execute() {// todo: requires call_contract_syscall
...
#[test]
#[available_gas(2000000)]
fn test_validate_transaction() {// todo: requires mocking TxInfo
}
