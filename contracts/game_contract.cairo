...
@view
func get_goblin_kill_count{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    guild: felt
) -> (res: felt) {
...
@external
func kill_goblin{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> () {
    alloc_locals;
...
func get_rewards{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    account: felt, val: felt, token_id: Uint256
) {
...
func distribute_points{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    IExperiencePoints.mint(contract_address=points_contract, to=account, amount=Uint256(10, 0));
    return ();
}
